...
export default function Mint() {
  ...
  const cost = useMemo(() => 0.04 * amount, [amount])
    ...
    if (address) {
      ...
      try {
        const approve: Call = {
          ...
          entrypoint: 'approve',
          calldata: [serializeAddress(contracts.mint), ...serializeU256(formatEther(cost))]
        }

        const mint: Call = {
          contractAddress: contracts.mint,
          entrypoint: 'mint',
          calldata: [...serializeU256(amount.toString())]
        }
